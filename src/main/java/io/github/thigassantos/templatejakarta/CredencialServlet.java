...
import io.github.thigassantos.templatejakarta.log.Log;
import io.github.thigassantos.templatejakarta.log.LogBeanLocal;
import io.github.thigassantos.templatejakarta.util.OperacaoBancoDados;
 ...
 * @author IFNMG
 */
@WebServlet(name = "CredencialServlet", urlPatterns = {"/CredencialServlet"})
public class CredencialServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        Log l = new Log(OperacaoBancoDados.INSERCAO.toString(),
                this.getClass().getName()+"> "+ cr);
        try{
          logBean.registrar(l);  
        }catch(Exception ex){
             Logger.getLogger(CredencialServlet.class.getName()).log(Level.SEVERE, null, ex);
        }
